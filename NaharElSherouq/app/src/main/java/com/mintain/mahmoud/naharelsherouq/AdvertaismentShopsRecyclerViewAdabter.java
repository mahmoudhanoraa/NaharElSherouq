...
public class AdvertaismentShopsRecyclerViewAdabter extends RecyclerView.Adapter<AdvertaismentShopsRecyclerViewAdabter.ViewHolder> {
    Context context;
    List<Advertaisment> advertaismentList;

    public AdvertaismentShopsRecyclerViewAdabter(Context context, List<Advertaisment> advertaismentList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        AdvertaismentShopsRecyclerViewAdabter.ViewHolder viewHolder = new AdvertaismentShopsRecyclerViewAdabter.ViewHolder(itemView);
        return viewHolder;
    }
...
//                Toast.makeText(context, "you selected "+ category.getName(), Toast.LENGTH_LONG).show();
                ...
                FragmentActivity host = (FragmentActivity) v.getContext();
                    ...
                    host.getSupportFragmentManager()
                            .beginTransaction()
                            .addToBackStack(null)
                            .replace(R.id.root_frame1, detailsFragment)
                            .commit();
